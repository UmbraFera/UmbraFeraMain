...
namespace NodeCanvas{
	...
	abstract public class NodeGraphContainer : MonoBehaviour, ITaskDefaults {
		...
		///Similar to Unity SendMessage + it forwards the message to all of the graph's tasks.
		...
		//TEMPORARY. REMOVE IN NEXT VERSION
		private void Reset(){
